# 공공 데이터 포털 (https://www.data.go.kr)에 csv 파일 다운받기
# csv파일을 읽어 들여서, 읽어 들인 데이터에서 가장 많이 사용된 명사 찾기
...
with open('./data/sample2.csv')as raws: # 파일변수가 raws임
...
# wordcloud 패키지 설치하고 사용함 => matplotlib도 자동 같이 설치됨
...
imgArray = np.array(img) # 이미지의 각 픽셀을 숫자 배열

wordcloud = WordCloud(
    font_path='./fonts/Malgun.ttc',
    background_color='white',
    width=400,
    height=400,
